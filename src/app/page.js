...
export default function Home() {
  const featuredClubs = [
    { id: 1, name: "Club RACE (레이스)", category: "EDM / House", rating: 4.8, location: "서울 강남", minPrice: "₩300,000" },
    { id: 2, name: "Jack Livin (잭리빈)", category: "Hip-Hop", rating: 4.6, location: "서울 신사", minPrice: "₩250,000" },
    { id: 3, name: "힙합클럽 5 (Club 5)", category: "Hip-Hop", rating: 4.9, location: "서울 홍대", minPrice: "₩200,000" },
    { id: 4, name: "Club Aura (아우라)", category: "EDM", rating: 4.7, location: "서울 홍대", minPrice: "₩150,000" },
  ];
  ...
  return (
    <div>
      ...
      <section style={{ background: 'var(--card-bg)', padding: '4rem 0', borderTop: '1px solid var(--card-border)', borderBottom: '1px solid var(--card-border)' }}>
